...
- [x] Dostosowanie środowisk do pracy grupowej
- [x] Przypomnienie sobie środowiska jakim jest  Python i nauka programowania strukturalnego
- [x] Podział pracy w grupie
- [x] Wspólne analizowanie wykonanych zadań
- [x] Połączenie zebranych materiałów 
